function shopping(input){
    ...
    const totalVideoCard = countOfVideoCards * videoCard;
    const totalProcessors = (totalVideoCard * 0.35) * countOfProcessors;
    const totalRamMemory = (totalVideoCard * 0.1) * countOfRamMemory;
